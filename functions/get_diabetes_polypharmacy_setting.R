get_diabetes_polypharmacy_setting <- function(){
    ...
    ipv = list(intercept_U = 0, intercept_sex = 0, intercept_age = 70, intercept_HbA1c = 50, 
               ...
               intercept_SGLT2 = 0, intercept_GLP1 = 0, 
               intercept_DPP4 = 0, intercept_History_SGLT2 = 0, intercept_History_GLP1 = 0, 
               ...
               effect_U_SGLT2 = 0, effect_sex_SGLT2 = 0, effect_age_SGLT2 = 0, 
               effect_HbA1c_SGLT2 = 0, effect_U_GLP1 = 0, effect_sex_GLP1 = 0, 
               effect_age_GLP1 = 0, effect_HbA1c_GLP1 = 0, effect_U_DPP4 = 0, 
               effect_sex_DPP4 = 0, effect_age_DPP4 = 0, effect_HbA1c_DPP4 = 0, 
               effect_U_History_SGLT2 = 0, effect_sex_History_SGLT2 = 0, effect_age_History_SGLT2 = 0, 
               effect_HbA1c_History_SGLT2 = 0, effect_U_History_GLP1 = 0, 
               effect_sex_History_GLP1 = 0, effect_age_History_GLP1 = 0, 
               effect_HbA1c_History_GLP1 = 0, effect_U_History_DPP4 = 0, 
               ...
               effect_MACE_death = 0, effect_changeHbA1c_death = 0, effect_SGLT2_death = 0, 
               effect_GLP1_death = 0, effect_DPP4_death = 0, effect_History_SGLT2_death = 0, 
               effect_History_GLP1_death = 0, effect_History_DPP4_death = 0, 
               effect_MACE_dropout = 0, effect_changeHbA1c_dropout = 0, 
               effect_SGLT2_dropout = 0, effect_GLP1_dropout = 0, effect_DPP4_dropout = 0, 
               effect_History_SGLT2_dropout = 0, effect_History_GLP1_dropout = 0, 
               effect_History_DPP4_dropout = 0, effect_changeHbA1c_MACE = 0, 
               effect_SGLT2_MACE = 0, effect_GLP1_MACE = 0, effect_DPP4_MACE = 0, 
               effect_History_SGLT2_MACE = 0, effect_History_GLP1_MACE = 0, 
